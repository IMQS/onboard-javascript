...
var ApiService = /** @class */ (function () {
    function ApiService() {
        var _this = this;
        this.columns = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://localhost:2050/columns')];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
        this.recordCount = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://localhost:2050/recordCount')];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
        this.records = function (fromId, toId) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://localhost:2050/records', {
                            params: {
                                from: fromId,
                                to: toId
                            },
        ...
        if ($("#myTable")) {
            ...
            this.columns().then(function (response) {
                ...
                var headersArr = ApiService.columnNames;
            ...
            this.records('0', '20').then(function (response) {
                ...
                var dataArr = ApiService.dataRecords;
